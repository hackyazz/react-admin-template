...
const getAxiosRequest = (method: string) => {
    ...
    return <T = unknown>(url: any, params = undefined, config = {}) => {
        return new Promise((resolve, reject) => {
            ...
            if (!(globalThis as any).__axios_controller_list__) {
                (globalThis as any).__axios_controller_list__ = [];
            }
            (globalThis as any).__axios_controller_list__.push(controller);
...
export const abortAllRequest = () => {
    if ((globalThis as any).__axios_controller_list__ !== undefined) {
        const controllerList = (globalThis as any).__axios_controller_list__ as AbortController[];
